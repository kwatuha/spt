...
<head>
	...
	<!--<script type="text/javascript" src="check_worked.js"></script>
	-->
...
<p>Personl infor presented here</p>
<div id="personaldata"></div>
<div id="alertdata"></div>
<div id="putitherea"></div>

<div id="form-ct"></div>


///////////////////////////////////////////
<input type="button" value="show form" onClick="launchForm()"/>
...
<button href="#" id='show-btn'>Displya report</button>
<input type="button" onClick="gridViewadmin_alert();" value="test click"/>

<!--<button href="#" onClick="closeDiv('alertdata','buttongalertgrid')">Close alert report</button>
<button href="#" id='buttongalertgrid'>buttonga lert grid</button>
<button onClick="getCurrentTableData('getData','admin_alert');">show message</`button>
<button   onMouseOver="defineGridcomns('admin_alert');"> definecolumns</button>
<button onClick="loadGridData('admin_alert');">load grid definition</button>-->
<buttonD onClick="showinfo('admin_alert')">sema grid</button>

<div id="currenttbltb">created code</div>
<div id="submitcode">coded</div>
<input type="button" onClick="getinfor();" value="testform"/>
</body>
</html>