...
public class SptConstants {
    ...
    public final static String GP_SPT_ENCRYPTED_FILE_DIR = "encrypted";
    public final static String GP_SPT_QUEUED_FILE_DIR = "queued";
    public final static String GP_SPT_UPLOADED = "uploaded";
    public final static String GP_PF_HAS_NO_EMAIL_ADDRESS_DIR = "no_contacts";
